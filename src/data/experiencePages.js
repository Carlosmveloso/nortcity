...
// Os negócios entram por parâmetro, vindos do banco (useBusinessCatalog). As
// listas abaixo são escolha editorial — quais fichas aparecem em cada página —
// e continuam no código, porque essa curadoria não existe no banco.
...
export function buildExperiencePages(businesses = []) {
    return {
        'roteiro-1-dia': {
